...
API_ID = int(environ.get('API_ID', '21769517')) # API ID from my.telegram.org
API_HASH = environ.get('API_HASH', 'a18bca05e643355610f88e15425287a7')  # API Hash from my.telegram.org
...
PICS = (environ.get('PICS', 'https://i.ibb.co/C5shyF3b/photo-2026-02-06-17-26-48-7603804998417252372.jpg https://i.ibb.co/d4FNBQrc/photo-2026-02-06-17-34-07-7603806888202862604.jpg https://i.ibb.co/nsvWKcyb/photo-2026-02-06-17-34-34-7603807008461946900.jpg https://i.ibb.co/Q3fLV1bP/photo-2026-02-06-17-35-06-7603807128721031196.jpg https://i.ibb.co/FbfC6qWY/photo-2026-02-06-17-35-23-7603807210325409796.jpg')).split()  # Sample pic
NOR_IMG = environ.get("NOR_IMG", "https://graph.org/file/e20b5fdaf217252964202.jpg")
MELCOW_PHOTO = environ.get("MELCOW_PHOTO", "https://graph.org/file/56b5deb73f3b132e2bb73.jpg")
SPELL_IMG = environ.get("SPELL_IMG", "https://graph.org/file/13702ae26fb05df52667c.jpg")
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://graph.org/file/242b7f1b52743938d81f1.jpg'))
FSUB_PICS = (environ.get('FSUB_PICS', 'https://i.ibb.co/bRvKt07v/photo-2025-10-28-00-07-26-7566057570234794000.jpg')).split()  # Fsub pic

# ============================
# Admin, Channels & Users Configuration
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7562079827').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003114810930').split()]  # Channel id for auto indexing (make sure bot is admin)

LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002841710905'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1003198950001'))  # Bin channel id (make sure bot is admin)
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1003169635320'))  # Premium logs channel id
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1003018305052')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1003148583595')  # Request channel id (make sure bot is admin)
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/godhelp19')  # Support group link (make sure bot is admin)

# FORCE_SUB 
auth_req_channels = environ.get("AUTH_REQ_CHANNELS", "-1002932338547")# requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
auth_channels     = environ.get("AUTH_CHANNELS", "-100")# Channels for force sub (make sure bot is admin)

# ============================
# Payment Configuration
# ============================
QR_CODE = environ.get('QR_CODE', 'https://i.ibb.co/60by2dPr/photo-2025-10-23-09-16-06-7564343530391339024.jpg')    # QR code image for payments
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'chauhanvikrambhai@fam')    # Owner UPI ID for payments
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://godsuraj564:Rb9HKktUHIN5qAnD@cluster0.p5pp1.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")  # MongoDB URI for the database
DATABASE_NAME = environ.get('DATABASE_NAME', "godsuraj564") # Database name (default: cluster)
...
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://trxmethod4_db_user:LKjcXB4atJWl7rVd@cluster0.hqmsci3.mongodb.net/?appName=Cluster0")  # MongoDB URI for the second database (if MULTIPLE_DB is True)
# ============================
...
TUTORIAL = environ.get("TUTORIAL", "https://t.me/ownergodupdate")   # Tutorial link for verification
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/ownergodupdate")   # Second tutorial link for verification
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/ownergodupdate")   # Third tutorial link for verification
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/ownergodupdate') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/ownergodupdate') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/ownergodupdate') # Update channel link for the bot
